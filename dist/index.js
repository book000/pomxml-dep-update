...
function findAsync(array, predicate) {
    return __awaiter(this, void 0, void 0, function* () {
...
function getDependencyRepo(repository, dependency) {
    return __awaiter(this, void 0, void 0, function* () {
        const depRepo = yield findAsync([...repository, MvnCentralRepository], (repository) => __awaiter(this, void 0, void 0, function* () {
            const url = getMavenMetadataXmlUrl(repository, dependency);
            const bool = yield existsUrl(url);
...
function parseMavenMetadata(repository, dependency) {
    return __awaiter(this, void 0, void 0, function* () {
        const url = getMavenMetadataXmlUrl(repository, dependency);
...
function main(pomPath, ignorePackages) {
    return __awaiter(this, void 0, void 0, function* () {
        const content = fs_1.default.readFileSync(pomPath, 'utf-8');
        const pom = yield parsePom(content);
        ...
        for (const dependency of pom.dependencies) {
            ...
            const repository = yield getDependencyRepo(pom.repositories, dependency);
            if (!repository) {
                console.warn('[main]', 'Dependency repo:', 'Not found');
                continue;
            }
            console.log('[main]', 'Dependency repo:', JSON.stringify(repository));
            const metadata = yield parseMavenMetadata(repository, dependency);
